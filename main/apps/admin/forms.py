...
class ConfigUpdateForm(wtf.Form):
  ...
  announcement_type = wtforms.SelectField('Announcement Type', choices=[(t, t.title()) for t in models.Config.announcement_type._choices])
  ...
  yandex_metrika_counter_number = wtforms.StringField('Counter number', filters=[util.strip_filter])
